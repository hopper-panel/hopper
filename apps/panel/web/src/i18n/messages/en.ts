...
export const en = {
  ...
  'permGroup.control.desc': 'Turn the server on and off, restart it, and send it commands from the console.',
  'permGroup.user.label': 'Subusers',
  'permGroup.user.desc': 'Manage other accounts’ access to this server. Nobody can grant a permission they do not hold themselves, nor change their own access.',
  'permGroup.file.label': 'Files',
  'permGroup.file.desc': 'Browse, edit and upload the server files, from the panel as well as over SFTP.',
  ...
  'permGroup.database.desc': 'Create and read the server’s MySQL databases. Reading one means seeing its password: that permission gives access to its whole content.',
  ...
  'permGroup.startup.desc': 'Change the launch command, the template variables and the Java version in use.',
  ...
  'permGroup.webhook.desc': 'Declare addresses told about the server’s events — Discord, or any service that accepts an incoming request.',
  ...
  'perm.WEBSOCKET_CONNECT.desc': 'See the server and its console, read-only. Granted by default: without it a subuser would not see the server they were just given access to.',
  'perm.CONTROL_CONSOLE.label': 'Send commands',
  'perm.CONTROL_CONSOLE.desc': 'Type commands into the console. Equivalent to the game’s admin console: one command can make anyone an operator.',
  'perm.CONTROL_START.label': 'Start',
  'perm.CONTROL_START.desc': 'Turn the server on when it is stopped.',
  'perm.CONTROL_STOP.label': 'Stop',
  'perm.CONTROL_STOP.desc': 'Shut the server down, and kill it if the clean stop fails. A killed server can lose the last changes to the world.',
  ...
  'perm.FILE_READ_CONTENT.desc': 'Open and download files. Plugin configurations often hold database passwords.',
  'perm.FILE_CREATE.label': 'Create and upload',
  'perm.FILE_CREATE.desc': 'Create folders and upload files. Dropping a plugin in amounts to having the server run code.',
  ...
  'perm.FILE_SFTP.desc': 'Connect over SFTP with the panel credentials. The file permissions above apply there too.',
  ...
  'perm.BACKUP_CREATE.desc': 'Start a backup. Once the limit is reached, the oldest unlocked one is replaced.',
  ...
  'perm.BACKUP_DOWNLOAD.desc': 'Take away a full copy of the server, world and configurations included.',
  'perm.BACKUP_RESTORE.label': 'Restore',
  'perm.BACKUP_RESTORE.desc': 'Put the server back into the state of a backup. Erases everything done since.',
  'perm.DATABASE_READ.label': 'See databases',
  'perm.DATABASE_READ.desc': 'Read the server’s databases, password included: this permission gives access to all their contents.',
  'perm.DATABASE_CREATE.label': 'Create a database',
  'perm.DATABASE_CREATE.desc': 'Create a MySQL database and its dedicated account, within the server’s allowance.',
  'perm.DATABASE_UPDATE.label': 'Change the password',
  'perm.DATABASE_UPDATE.desc': 'Regenerate a database password. The old one stops working at once: plugins configured with it lose the connection.',
  ...
  'perm.ALLOCATION_CREATE.desc': 'Assign one more port to the server, for a dynamic map for instance.',
  ...
  'perm.STARTUP_UPDATE.desc': 'Change the template variables, including the file run when the server launches.',
  'perm.STARTUP_DOCKER_IMAGE.label': 'Change the Docker image',
  'perm.STARTUP_DOCKER_IMAGE.desc': 'Pick the Java version running the server, among those the template offers.',
  ...
  'perm.SCHEDULE_UPDATE.desc': 'Change the timing and steps of a schedule, and trigger it right away.',
  ...
  'perm.SETTINGS_REINSTALL.desc': 'Run the template install script again. Depending on the template, server files may be overwritten.',
  ...
  'perm.WEBHOOK_CREATE.desc': 'Declare an address the panel will call. The panel then sends an outgoing request to an address chosen by whoever holds this permission.',
  'perm.WEBHOOK_UPDATE.label': 'Edit a notification',
  'perm.WEBHOOK_UPDATE.desc': 'Change the address, the subscribed events or the state of a notification.',

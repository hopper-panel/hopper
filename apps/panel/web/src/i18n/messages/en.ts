...
export const en = {
  ...
  'backups.excludedHint': 'One pattern per line, .gitignore syntax: * and ** are accepted, and a leading ! brings back what an earlier rule excluded. Left empty, the .hopperignore file at the server root is used if it exists.',
  'backups.locked': 'Locked',
  'backups.lockedHint': 'Prevents this backup from being deleted, retention included, until it is unlocked.',
  'backups.lockedBadge': 'locked',
  'backups.runningNotice': 'A backup is already running. Wait for it to finish before starting another.',
  ...
  'backups.restoreWarning': 'Every current file of the server will be deleted, then replaced by those of this backup. The server must be stopped.',
